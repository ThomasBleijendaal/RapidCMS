        ...
        public static void AddManytoManyManyACollection(this ICmsConfig config)
        {
            config.AddCollection<ManytoManyManyA, BaseRepository<ManytoManyManyA>>(
                ...
                collection =>
                {
                    ...
                    collection.AddEntityValidator<ManytoManyManyAValidator>();
...
namespace RapidCMS.ModelMaker
{
    public class ManytoManyManyARepository : BaseRepository<ManytoManyManyA>
    {
        ...
        public override async Task<IEnumerable<ManytoManyManyA>> GetAllAsync(IParent? parent, IView<ManytoManyManyA> view)
        {
            return await view.ApplyOrder(view.ApplyDataView(_dbContext.ManytoManyManyAs)).Skip(view.Skip).Take(view.Take).AsNoTracking().ToListAsync();
        }
