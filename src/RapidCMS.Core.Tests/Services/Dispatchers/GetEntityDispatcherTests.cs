...
namespace RapidCMS.Core.Tests.Services.Dispatchers
{
    public class GetEntityDispatcherTests
    {
        ...
        [TestCase(UsageType.New, default(string), typeof(DefaultEntityVariant))]
        ...
        {
            // act
            var context = await _subject.GetAsync(new GetEntityRequestModel { UsageType = usageType, CollectionAlias = "alias", Id = id });
